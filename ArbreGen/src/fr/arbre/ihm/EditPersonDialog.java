...
public class EditPersonDialog extends JDialog implements ActionListener {
	...
	private EditPersonDialog(Frame frame, String title, SimplePerson person) {
		...
		fatherNameField = new JTextField("MonsieurFather", 12);
		...
		JButton buttonFplus = new JButton("+"); // TODO remplacer par une icone
		c.gridx = 10;
		c.weightx = 0;
		c.gridwidth = 1;
		add(buttonFplus, c);
		
		JButton buttonFminus = new JButton("-");
		c.gridx = 11;
		c.gridwidth = 1;
		add(buttonFminus, c);
		...
		JButton buttonMplus = new JButton("+"); // TODO remplacer par une icone
		c.gridx = 10;
		c.weightx = 0;
		c.gridwidth = 1;
		add(buttonMplus, c);
